...
namespace ve 
{
	...
	VeTexture::VeTexture(VeDevice& device, const std::string& textureFilepath) : mDevice{ device } {
	...
	void VeTexture::createTextureImageView(VkImageViewType viewType) {
		VkImageViewCreateInfo viewInfo{};
		viewInfo.sType = VK_STRUCTURE_TYPE_IMAGE_VIEW_CREATE_INFO;
		viewInfo.image = mTextureImage;
	...
	void VeTexture::transitionLayout(
